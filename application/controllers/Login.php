...
class Login extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if (@$_SESSION['is_login']) {
            ...
            elseif ($_SESSION['id_otoritas'] == 4) $link = base_url('accounting/dashboard');
            ...
            elseif ($_SESSION['id_otoritas'] == 9) $link = base_url('cs/dashboard');
            redirect($link);
        }
    ...
    public function auth()
    {
        ...
        if ($run) {
            ...
            elseif ($run->id_otoritas == 4) $link = base_url('accounting/dashboard');
            ...
            elseif ($run->id_otoritas == 9) $link = base_url('cs/dashboard');
