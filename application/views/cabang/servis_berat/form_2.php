...
<form onsubmit="event.preventDefault();do_submit(this);">
    ...
    <div class="text-center">
        <button data-value="3" type="button" onclick="set_radio(this,'btn_konfirmasi');cek_konfirmasi(3);" class="btn btn-outline-danger btn-lg fw-600 btn_konfirmasi mx-2">Menunggu SparePart</button>
        <button data-value="4" type="button" onclick="set_radio(this,'btn_konfirmasi');cek_konfirmasi(4);" class="btn btn-outline-danger btn-lg fw-600 btn_konfirmasi mx2">Menunggu Konfirmasi User</button>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" required readonly id="part" name="harga_part" onchange="hitung_modal();" autocomplete="off" placeholder="Masukkan isian" class="form-control rupiah wajib" value="0">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
