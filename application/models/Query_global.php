...
class Query_global extends CI_Model
{
    ...
    {
        $penjualan_1 = "SELECT a.id_cabang, a.id as id_asal, (case when a.id_jenis_pembayaran=10 then DATE(a.verif_waktu) else DATE(a.created) end ) as tanggal,'PENJUALAN' as jenis_transaksi, (a.bayar - (a.potongan+(case when a.id_jenis_pembayaran=2 then a.kembalian else 0 end ))) as kredit, 0 as debit, a.dp,
        ...
        where a.deleted is null and 1=(case when a.id_jenis_pembayaran=10 then (case when a.verif_paylater='1' then 1 else 0 end) else 1 end) ";

        $penjualan_2 = "SELECT a.id_cabang, a.id as id_asal, DATE(a.created) as tanggal,'PENJUALAN SPLIT' as jenis_transaksi, (a.total_split - (a.potongan_split+(case when a.id_jenis_pembayaran_2=2 then a.kembalian else 0 end ))) as kredit, 0 as debit, a.dp,
        ...
        $dp_kredit = "SELECT a.id_cabang, a.id as id_asal, a.tanggal, 'DP' as jenis_transaksi, (a.total-a.total_potongan) as kredit, 0 as debit, 0 as dp, CONCAT(b.nama,'(',a.total_potongan,')') as jenis_pembayaran, a.pembayaran as id_pembayaran,
        ...
        $dp_debit = "SELECT a.id_cabang, a.id as id_asal, a.tgl_refund as tanggal, 'REFUND DP' as jenis_transaksi, 0 as kredit, a.total as debit, 0 as dp, b.nama as jenis_pembayaran, a.pembayaran as id_pembayaran,
        CONCAT(a.kode, '<br>', a.keterangan) as keterangan, a.no_hp, '' as tgl_dp, a.nama as nama_user, c.nama as nm_cabang
        from dp a
        left join ref_jenis_pembayaran b on b.id=a.pembayaran
        left join ref_cabang c on c.id=a.id_cabang
        ...
        $operasional_debit = "SELECT a.id_cabang, a.id as id_asal, a.tanggal, 'OPERASIONAL' as jenis_transaksi, 0 as kredit, a.jumlah as debit, 0 as dp, b.nama as jenis_pembayaran, a.id_pembayaran as id_pembayaran,
        ...
        $operasional_kredit = "SELECT a.id_cabang, a.id as id_asal, a.tgl_refund as tanggal, 'OPERASIONAL REFUND' as jenis_transaksi, a.jumlah as kredit, 0 as debit, 0 as dp, b.nama as jenis_pembayaran, a.id_pembayaran as id_pembayaran,
        ...
        $kerugian = "SELECT a.id_cabang, a.id as id_asal, a.tanggal, 'KERUGIAN' as jenis_transaksi, 0 as kredit, a.jumlah as debit, 0 as dp, b.nama as jenis_pembayaran, a.id_pembayaran as id_pembayaran,
        ...
        $kasbon = "SELECT a.id_cabang, a.id as id_asal, a.tanggal, 'KASBON' as jenis_transaksi, 0 as kredit, a.jumlah as debit, 0 as dp, b.nama as jenis_pembayaran, a.id_pembayaran as id_pembayaran,
        ...
        $modal_awal = "SELECT a.id_cabang, a.id as id_asal, a.tanggal, 'MODAL AWAL CASH' as jenis_transaksi, a.modal as kredit, 0 as debit, 0 as dp, b.nama as jenis_pembayaran, a.id_pembayaran as id_pembayaran,
        ...
        $servis_kredit_1 = "SELECT a.id_cabang, a.id as id_asal, a.tgl_keluar as tanggal, 'SERVIS IC' as jenis_transaksi, (a.bayar - (a.potongan + (case when a.id_jenis_pembayaran=2 then a.kembalian else 0 end ))) as kredit, 0 as debit, 0 as dp, 
        CONCAT(b.nama,'(',a.potongan,')') as jenis_pembayaran, a.id_jenis_pembayaran as id_pembayaran,
        ...
        $servis_kredit_2 = "SELECT a.id_cabang, a.id as id_asal, a.tgl_keluar as tanggal, 'SERVIS IC SPLIT' as jenis_transaksi, (a.bayar_split - (a.potongan_split + (case when a.id_jenis_pembayaran_2=2 then a.kembalian else 0 end ))) as kredit, 0 as debit, 0 as dp, 
        ...
        $servis_debit = "SELECT a.id_cabang, a.id as id_asal, a.tgl_keluar as tanggal, 'REFUND SERVIS IC' as jenis_transaksi, 0 as kredit, a.biaya as debit, 0 as dp, 
        ...
        $setor_tunai_debit = "SELECT a.id_cabang, a.id as id_asal, a.tanggal, 'SETOR TUNAI' as jenis_transaksi, 0 as kredit, a.nominal as debit, 0 as dp, 'CASH' as jenis_pembayaran, 2 as id_pembayaran,
        CONCAT(a.keterangan) as keterangan, '' as no_hp, '' as tgl_dp, '' as nama_user, c.nama as nm_cabang
        from setor_tunai a
        left join ref_jenis_pembayaran b on b.id=a.id_pembayaran
        left join ref_cabang c on c.id=a.id_cabang
        ...
        $setor_tunai_kredit = "SELECT a.id_cabang, a.id as id_asal, a.tanggal, 'SETOR TUNAI' as jenis_transaksi, a.nominal as kredit, 0 as debit, 0 as dp, b.nama as jenis_pembayaran, a.id_pembayaran as id_pembayaran,
        CONCAT(a.keterangan) as keterangan, '' as no_hp, '' as tgl_dp, '' as nama_user, c.nama as nm_cabang
        from setor_tunai a
        left join ref_jenis_pembayaran b on b.id=a.id_pembayaran
        left join ref_cabang c on c.id=a.id_cabang
        ...
        $refund_penjualan_debit = "SELECT a.id_cabang_asal as id_cabang, a.id as id_asal, a.tanggal, 'REFUND PENJUALAN' as jenis_transaksi, 0 as kredit, b.nilai_refund as debit, 0 as dp, c.nama as jenis_pembayaran, b.pembayaran as id_pembayaran,
        ...
        where a.deleted is null and b.deleted is null and b.id_klaim in (3,4) ";
