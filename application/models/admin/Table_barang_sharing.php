    ...
    function generate_table()
    {
        ...
        foreach ($list as $field) {
            ...
            if ($field->is_konfirmasi == '1') {
                ...
                $row[] = '
                    <div class="btn-group">
                        <a href="' . base_url($this->type . '/barang_sharing_detail/index/' . encode_id($field->id)) . '" data-toggle="tooltip" data-placement="top" title="detail barang" class="btn btn-success fw-600 my_tooltip"><i class="far fa-list-alt"></i></a>
                    </div>
                ';
            } else {
                ...
                $row[] = '                    
                    <div class="btn-group">
                        <a href="' . base_url($this->type . '/barang_sharing_detail/index/' . encode_id($field->id)) . '" data-toggle="tooltip" data-placement="top" title="detail barang" class="btn btn-warning fw-600 my_tooltip"><i class="far fa-list-alt"></i></a>
                        <button onclick="ubah(\'' . encode_id($field->id) . '\');" type="button" data-toggle="tooltip" data-placement="top" title="edit sharing" class="btn btn-primary fw-600 my_tooltip"><i class="fas fa-edit"></i></button>
                        <button onclick="hapus(\'' . encode_id($field->id) . '\');" type="button" data-toggle="tooltip" data-placement="top" title="hapus sharing" class="btn btn-danger fw-600 my_tooltip"><i class="fas fa-trash-alt"></i></button>
                    </div>
                ';
            }
