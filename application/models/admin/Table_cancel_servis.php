...
class Table_cancel_servis extends CI_Model
{
    ...
    private function _get_datatables_query()
    {
        ...
        f.nama as nm_cabang, b.tgl_cancel
        from (
            SELECT
                a.id_cabang AS id_cabang,
                a.id AS id,
                a.tgl_keluar AS tgl_keluar,
                a.biaya AS biaya,
                a.harga_part AS harga_part,
                a.modal AS modal,
                a.prosen_split_1 AS prosen_split_1,
                a.prosen_split_2 AS prosen_split_2,(
                    a.bayar * ( a.prosen_split_1 / 100 )) AS potongan1,(
                    a.bayar_split * ( a.prosen_split_2 / 100 )) AS potongan2,(
                    a.biaya - ((
                            a.bayar * ( a.prosen_split_1 / 100 )) + (
                            a.bayar_split * ( a.prosen_split_2 / 100 )))) AS sub_total,((
                        a.biaya - ((
                                a.bayar * ( a.prosen_split_1 / 100 )) + (
                            a.bayar_split * ( a.prosen_split_2 / 100 )))) - a.modal 
                ) AS profit 
            FROM
                servis_berat a 
            WHERE a.bayar IS NOT NULL
        ) as a 
