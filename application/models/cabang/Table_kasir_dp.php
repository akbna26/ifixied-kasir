...
class Table_kasir_dp extends CI_Model
{
    ...
    function generate_table()
    {
        ...
        foreach ($list as $field) {
            ...
            $row[] = $field->kode;
            $row[] = '<a href="' . base_url('cabang/cetak/nota_dp/' . encode_id($field->id)) . '" target="_blank" class="btn btn-sm btn-success fw-600"><i class="fas fa-print"></i> Cetak</a>';
            ...
            elseif ($field->is_refund == '1') {
                ...
                if (session('type') == 'admin' && $field->is_cancel != '1') {
            ...
            if ($field->deleted == null) {
                ...
                if ($field->is_selesai == '1' && $field->inv_dp != '' || $field->is_refund == '1') {
                    ...
                    if (session('type') == 'admin' && $field->inv_dp == '') {
