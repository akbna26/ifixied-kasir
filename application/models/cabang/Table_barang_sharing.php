...
class Table_barang_sharing extends CI_Model
{
    ...
    private function _get_datatables_query()
    {
        ...
        $this->db->where('a.is_konfirmasi', '1');
    ...
    function generate_table()
    {
        ...
        foreach ($list as $field) {
            ...
            if ($field->is_konfirmasi == '1') {
                ...
                $row[] = '
                    <div class="btn-group">
                        <a href="' . base_url('cabang/barang_sharing_detail/index/' . encode_id($field->id)) . '" data-toggle="tooltip" data-placement="top" title="detail barang" class="btn btn-success fw-600"><i class="far fa-list-alt"></i></a>
                    </div>
                ';
            } else {
                ...
                $row[] = '                    
                    <div class="btn-group">
                        <a href="' . base_url('cabang/barang_sharing_detail/index/' . encode_id($field->id)) . '" data-toggle="tooltip" data-placement="top" title="detail barang" class="btn btn-warning fw-600"><i class="far fa-list-alt"></i></a>
